  ...
  "group/bubble relative flex w-fit max-w-[80%] min-w-0 flex-col gap-1 group-data-[align=end]/message:self-end data-[align=end]:self-end data-[variant=ghost]:max-w-full",
  {
    variants: {
      variant: {
        ...
        user:
          "*:data-[slot=bubble-content]:bg-[#00d692] *:data-[slot=bubble-content]:text-black [&>[data-slot=bubble-content]:is(button,a):hover]:bg-[#25A17A]",

        llm:
          "*:data-[slot=bubble-content]:bg-zinc-100 *:data-[slot=bubble-content]:text-zinc-900 [&>[data-slot=bubble-content]:is(button,a):hover]:bg-zinc-200"
      },
    },
    defaultVariants: {
      variant: "default",
